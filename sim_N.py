...
def NNSMC_e2_run():
    ...
    nn_controller = Neraul_Network_Controller(p,v,'L2_y')
    ...
    B_F=np.ones(num_carriage)#virtual_train.M.copy()
...
def NNSMC_ey2_run():
    ...
    nn_controller = Neraul_Network_Controller(p,v,'L2_e_y')
    adp = Adaptive_Law(t_sampling)
